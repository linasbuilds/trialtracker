      ...
      const trialsHtml = matchingTrials.map(trial => {
        ...
        return `
          <div style="background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:20px;margin-bottom:16px;">
            ...
            <a href="${trial.official_link || 'https://trialtracker.app'}" style="background:#2563eb;color:white;padding:10px 20px;border-radius:8px;text-decoration:none;font-weight:bold;">View & Register →</a>
          </div>`;
      }).join('');
        ...
        html: `<!DOCTYPE html>
          ...
          <body style="font-family:-apple-system,sans-serif;background:#f8fafc;padding:24px;margin:0;">
            <div style="max-width:600px;margin:0 auto;">
              <div style="background:#2563eb;border-radius:16px;padding:24px;text-align:center;margin-bottom:24px;">
                <h1 style="margin:0;color:white;font-size:28px;font-weight:900;">🐾 TrialTracker</h1>
                <p style="margin:8px 0 0 0;color:#bfdbfe;">Trial entries opening soon!</p>
              </div>
              ${trialsHtml}
              <p style="color:#94a3b8;font-size:12px;text-align:center;margin-top:24px;">
                You're receiving this because you have alerts enabled on TrialTracker.<br>
                <a href="mailto:support@trialtracker.app?subject=Unsubscribe" style="color:#94a3b8;">Unsubscribe</a>
              </p>
            </div>
          </body>
          </html>`,
